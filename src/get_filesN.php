<?php 
$folderPath = '../public/docs/normativa'; // Ruta de la carpeta donde se encuentran los documentos PDF
...
foreach ($folders as $folder) {
    ...
    //echo $file."<br>";
    echo '<button type="button" class="m-3  btn btn-outline-danger btn-lg" onclick="showPdfTestN(\'' . $folderName . '\')" /><i class="fa-solid fa-folder"></i> '. $file.'</button>';
}
}
echo '</div>';
