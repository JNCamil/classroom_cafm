    ...
    <div class="col-lg-6 h-100 p-5" id="logincol">
        <div class="row ">
            ...
            <div class="col-12 text-white my-5">
                <h3>CLASROOM CAFM</h3>
                <h4>¡¡Importante!!</h4>
                <p>Aquellos que pertenezcan al comité técnico de árbitros podrán ingresar con la cuenta emitida por la
                ...
                <div class="card-body">
                    ...
                    <form action="registro.php" method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <input placeholder="Email" type="email" class="form-control" name="email" aria-describedby="emailHelp">
